...
class OrdensControllerTest < ActionController::TestCase
  ...
  test "should create orden" do
    assert_difference('Orden.count') do
      post :create, orden: { descripcion: @orden.descripcion, fecha: @orden.fecha, precio: @orden.precio, productos: @orden.productos, restaurante_id: @orden.restaurante_id, user_id: @orden.user_id }
    end
  ...
  test "should update orden" do
    patch :update, id: @orden, orden: { descripcion: @orden.descripcion, fecha: @orden.fecha, precio: @orden.precio, productos: @orden.productos, restaurante_id: @orden.restaurante_id, user_id: @orden.user_id }
    assert_redirected_to orden_path(assigns(:orden))
  end
