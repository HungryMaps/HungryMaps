...
class OpinionsControllerTest < ActionController::TestCase
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post :create, opinion: { comentario: @opinion.comentario, restaurante_id: @opinion.restaurante_id, user_id: @opinion.user_id }
    end
  ...
  test "should update opinion" do
    patch :update, id: @opinion, opinion: { comentario: @opinion.comentario, restaurante_id: @opinion.restaurante_id, user_id: @opinion.user_id }
    assert_redirected_to opinion_path(assigns(:opinion))
  end
