...
class RestaurantesControllerTest < ActionController::TestCase
  ...
  test "should create restaurante" do
    assert_difference('Restaurante.count') do
      post :create, restaurante: { direccion_id: @restaurante.direccion_id, nombre_restaurante: @restaurante.nombre_restaurante, tipo_comida_id: @restaurante.tipo_comida_id }
    end
  ...
  test "should update restaurante" do
    patch :update, id: @restaurante, restaurante: { direccion_id: @restaurante.direccion_id, nombre_restaurante: @restaurante.nombre_restaurante, tipo_comida_id: @restaurante.tipo_comida_id }
    assert_redirected_to restaurante_path(assigns(:restaurante))
  end
