...
class UbicacionsControllerTest < ActionController::TestCase
  ...
  test "should create ubicacion" do
    assert_difference('Ubicacion.count') do
      post :create, ubicacion: { canton: @ubicacion.canton, distrito: @ubicacion.distrito, provincia: @ubicacion.provincia, restaurante_id: @ubicacion.restaurante_id }
    end
  ...
  test "should update ubicacion" do
    patch :update, id: @ubicacion, ubicacion: { canton: @ubicacion.canton, distrito: @ubicacion.distrito, provincia: @ubicacion.provincia, restaurante_id: @ubicacion.restaurante_id }
    assert_redirected_to ubicacion_path(assigns(:ubicacion))
  end
