...
class UbicacionsControllerTest < ActionController::TestCase
  ...
  test "should create ubicacion" do
    assert_difference('Ubicacion.count') do
      post :create, ubicacion: { canton_id: @ubicacion.canton_id, distrito_id: @ubicacion.distrito_id, provincia_id: @ubicacion.provincia_id, señas: @ubicacion.señas }
    end
  ...
  test "should update ubicacion" do
    patch :update, id: @ubicacion, ubicacion: { canton_id: @ubicacion.canton_id, distrito_id: @ubicacion.distrito_id, provincia_id: @ubicacion.provincia_id, señas: @ubicacion.señas }
    assert_redirected_to ubicacion_path(assigns(:ubicacion))
  end
